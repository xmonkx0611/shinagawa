// --- TRIP DATA FILE ---
// Version: 4.0.0 (Master Picks, Cross-border Fallback & Absolute Pointer Edition)
...
const tripData = {
    ...
    "missionSummary": {
        ...
        "ramen": { "completed": true, "description": "拉麵店 (Day 4: TOKYO 豚骨 BASE (ecute品川))" },
    ...
    "dailyData": {
        "day1": {
            ...
            "insights": {
                "business_insight": {
                    "title": "💡 商業大師洞察",
                    "text": "將長程移動時間轉化為高專注度的策略規劃期，是高階經理人維持大局觀的必備技能。"
                },
                "local_creation": {
                    "title": "🏛️ 文化大師見解",
                    "placeKey": "道の駅 富浦 枇杷俱樂部",
                    "text": "南房總地區的 道の駅 富浦 枇杷俱樂部 展現了日本如何將地方創生、農產精緻化與觀光完美結合的頂級商業模式。"
                }
            },
            "timeline": [
                { 
                    ...
                    "extraInfo": [{ "type": "strategy", "text": "🎯 旅遊大師建議：雖是台灣分店，但作為早班機前的高效熱食能量補充最為合適。" }],
                    "cost": "NT$150", "stay": "45m" 
                },
                { 
                    "time": "09:00", "type": "✈️", "event": "長榮航空 BR198 啟航", "description": "商務艙尊榮環境。", 
                    "extraInfo": [{ "type": "strategy", "text": "🎯 旅遊達人布萊N 建議：航程中請確保已完成 Visit Japan Web 申報，落地通關更順暢。" }], 
                    "cost": "無", "stay": "3.5h" 
                },
                { 
            ...
            "intel": { 
                "supply": { 
                    "title": "🏪 鄉間唯一補給", 
                    "placeKey": "7-Eleven 南房總富浦多田良店",
                    "text": "7-Eleven 南房總富浦多田良店 是飯店周邊唯一大型超商，請於入住前買齊房內宵夜與當地限定甜點。" 
                }
            }
        },
        "day2": {
            ...
            "insights": {
                "networking": {
                    "title": "💡 商業大師洞察",
                    "text": "櫻花季是日本企業極為重視的時節，以此作為破冰話題，極有助於建立長遠的信任關係。"
                },
                "urban_planning": {
                    "title": "🏙️ 都市規劃大師見解",
                    "placeKey": "台場海濱地區",
                    "text": "台場海濱地區 的無電線桿設計與立體人車分道，是東京臨海副都心開發的絕佳縮影。"
                }
            },
            "timeline": [
                ...
                { 
                    ...
                    "extraInfo": [{ "type": "strategy", "text": "🎯 建築大師建議：交流會位於『日本都市景觀 100 選』之核心示範區內，請特別觀察其親水空間規劃。" }], 
                    "cost": "無", "stay": "6.5h" 
                },
                { 
                    ...
                    "extraInfo": [
                        { "type": "photo", "text": "📸 攝影大師絕景：在此露台可同時捕捉彩虹大橋與自由女神像，是『日本百景』級別的經典構圖點。" },
                        { "type": "recommend", "text": "🔥 必訪理由：台灣雖有星巴克，但日本常販售極具特色的『哈密瓜星冰樂』或『櫻花季限定周邊』，絕對值得一試！" }
                    ], 
                    "cost": "¥700", "stay": "1h" 
                },
            ...
            "intel": { 
                "supply": { 
                    "title": "🏪 台場商圈深夜機能", 
                    "placeKey": "Lawson お台場海濱公園前店",
                    "text": "Lawson お台場海濱公園前店 是網紅極推的高評價門市，炸雞君首選；若需藥妝可至 マツモトキヨシ Aqua City店。" 
                }
            }
        },
        "day3": {
            ...
            "insights": {
                "culture_insight": {
                    "title": "🏛️ 文化大師洞察",
                    "placeKey": "明治神宮",
                    "text": "明治神宮 的百年造林計畫與『和魂洋才』理念，至今仍是日本企業推動 SDGs (永續發展目標) 的最高標竿。"
                },
                "tech_insight": {
                    "title": "⚙️ 科技大師見解",
                    "placeKey": "くら寿司 台場店",
                    "text": "連鎖迴轉壽司的自動化送餐軌道與計盤扭蛋系統，完美展現了日本餐飲業應對高齡化與缺工的數位轉型對策。"
                }
            },
            "timeline": [
                ...
                { 
                    ...
                    "extraInfo": [
                        { "type": "photo", "text": "📸 攝影大師推薦：別錯過來自台灣阿里山的巨型檜木大鳥居，以及象徵和魂洋才的巨大酒樽牆。" },
                        { "type": "strategy", "text": "🎯 旅遊大師林氏璧：強烈建議攜帶御朱印帳，神宮的印記非常古典精美。" }
                    ], 
                    "cost": "無", "stay": "2.5h" 
                },
                { 
                    "time": "12:00", "type": "🍛", "event": "午餐: 邁泉豬排 青山本店", "placeKey": "邁泉豬排 青山本店", 
                    "description": "解鎖任務：老字號豬排定食（正餐）。", 
                    "extraInfo": [{ "type": "recommend", "text": "🎯 私房景點大師：本店由傳統公共澡堂(錢湯)改建，挑高天花板與舊時澡堂的輪廓極具特色，視覺與味覺雙重享受。" }], 
                    "cost": "¥2,500", "stay": "1.5h" 
                },
                ...
                { 
                    ...
                    "extraInfo": [
                        { "type": "recommend", "text": "🔥 必吃理由：日本當地店鋪擁有許多台灣絕對吃不到的『在地漁獲/季節限定品項』，且扭蛋機常有日本獨佔的最新動漫聯名！" },
            ...
            "intel": { 
                "supply": { 
                    "title": "🛒 深夜機能切換 (超市/居酒屋)", 
                    "placeKey": "マルエツ お台場店",
                    "text": "マルエツ お台場店 是在地主婦最愛的生鮮超市，極適合採買草莓；若想喝一杯，権八 お台場 具備濃厚江戶風情且營業至深夜。" 
                }
            }
        },
        "day4": {
            ...
            "insights": {
                "economy_insight": {
                    "title": "💡 經濟大師洞察",
                    "placeKey": "品川王子大飯店",
                    "text": "品川作為磁浮中央新幹線的起點，正進行大規模的『高輪Gateway』重劃，是東京下一個十年的絕對經濟引擎。"
                },
                "retail_insight": {
                    "title": "🏬 零售大師見解",
                    "placeKey": "ecute 品川",
                    "text": "觀察 ecute 品川 車站內商場的動線設計與超高翻桌率，這是日本鐵道商圈坪效的極致表現。"
                }
            },
            "timeline": [
                { 
                    ...
                    "description": "日式連鎖朝食。", 
                    "extraInfo": [{ "type": "recommend", "text": "🔥 必吃理由：日本當地的松屋擁有豐富的『期間限定定食』，米飯質地與牛肉醬汁比例也與海外店有著微妙且道地的差異！" }],
                    "cost": "¥600", "stay": "45m" 
                },
                ...
                { 
                    ...
                    "extraInfo": [{ "type": "recommend", "text": "⛩️ 榮耀點：周邊有『東京十社』之一的 品川神社，其境內的 品川神社富士塚 是關東最大，為絕佳微型朝聖點。" }], 
                    "cost": "無", "stay": "4.5h" 
                },
                ...
                { 
                    ...
                    "extraInfo": [
                        { "type": "recommend", "text": "🍜 必吃理由：此品牌是專為 JR 東日本打造的車站限定品牌，提供台灣吃不到的結合東京醬油風格的特殊豚骨風味！" },
                        { "type": "strategy", "text": "🍥 在地備案：若想吃完全不同的流派，品川站外的 麺達七人衆 品達 聚集了多間頂尖拉麵名店可供選擇。" }
                    ],
                    "cost": "¥1,200", "stay": "1h" 
                },
            ...
            "intel": { 
                "supply": { 
                    "title": "🏮 品川初夜探索 (居酒屋與急救)", 
                    "placeKey": "品川駅 港南口 居酒屋街",
                    "text": "品川駅 港南口 居酒屋街 充滿昭和風情；若需藥品，トモズ 品川店 營業較晚，適合補充B群與護眼藥水。" 
                }
            }
        },
        "day5": {
            ...
            "insights": {
                "retail_insight": {
                    "title": "🏬 零售大師洞察",
                    "placeKey": "秋葉原電器街",
                    "text": "觀察澀谷或 秋葉原電器街 的垂直型商場設計，其強迫客流由上而下滲透的『噴泉效應』，是極佳的動線案例。"
                },
                "hospitality_insight": {
                    "title": "🥂 服務大師見解",
                    "placeKey": "叙々苑 品川",
                    "text": "叙々苑 品川 不僅提供頂級和牛，其無微不至的桌邊服務與隱私空間規劃，是日本高階商務宴客的標準模式。"
                }
            },
            "options": {
                "optionA": {
                    ...
                    "timeline": [
                        ...
                        { 
                            ...
                            "description": "澀谷最高地標。", 
                            "extraInfo": [
                                { "type": "recommend", "text": "🥂 任務：前往 46 樓 Shibuya Sky 酒吧，解鎖高空下午茶任務。" }, 
                                { "type": "photo", "text": "📸 攝影大師絕景：從此處可遠眺『日本 100 名城』江戶城 (皇居外苑) 與富士山方向，強烈建議攜帶廣角鏡頭。" }
                            ],
                            "cost": "自理", "stay": "3.5h" 
                        },
                        { "time": "18:30", "type": "🥩", "event": "晚餐: 叙々苑 品川", "placeKey": "叙々苑 品川", "description": "頂級和牛燒肉盛宴（正餐）。", "cost": "¥10,000", "stay": "2h" },
                        { "time": "21:00", "type": "🏨", "event": "住宿: 品川王子大飯店", "placeKey": "品川王子大飯店", "description": "品川連泊第二晚 (終極採購)。", "cost": "無", "stay": "過夜" }
                    ]
                },
                "optionB": {
                    ...
                    "timeline": [
                        { 
                            ...
                            "extraInfo": [{ "type": "recommend", "text": "🔥 必吃理由：日本特有的『極上起司牛丼』以及期間限定海鮮丼，清晨來一碗熱騰騰豚汁更是道地體驗！" }],
                            "cost": "¥600", "stay": "45m" 
                        },
                        { "time": "10:30", "type": "🏢", "event": "研討: 高輪分部進階座談", "description": "商務交流與研討。", "cost": "無", "stay": "2h" },
                        { 
                            ...
                            "extraInfo": [{ "type": "recommend", "text": "📸 社群大師推薦：此處為多部動畫聖地，更是 Yodobashi Camera 秋葉原店 旗艦店所在地，免稅電器一站買齊。" }], 
                            "cost": "自理", "stay": "4.5h" 
                        },
                        { "time": "18:00", "type": "🍛", "event": "晚餐: Denny's 秋葉原店", "placeKey": "Denny's 秋葉原店", "description": "解鎖任務：正宗日式家庭餐廳體驗（正餐）。", "extraInfo": [{ "type": "strategy", "text": "🎯 旅遊大師推薦：體驗道地的日式 Family Restaurant 文化，多汁漢堡排與百匯甜點是靈魂。" }], "cost": "¥1,800", "stay": "1.5h" },
                        { "time": "20:30", "type": "🏨", "event": "住宿: 品川王子大飯店", "placeKey": "品川王子大飯店", "description": "品川連泊第二晚 (終極採購)。", "cost": "無", "stay": "過夜" }
                    ]
                }
            },
            "intel": { 
                "supply": { 
                    "title": "🛍️ 終極掃貨地圖 (品川周邊)", 
                    "placeKey": "ドン・キホーテ 品川港南口店",
                    "text": "ドン・キホーテ 品川港南口店 是 24H 營業的免稅伴手禮最後防線；若需生鮮，飯店地下的 京急ストア 品川店 營業至晚間10點。" 
                }
            }
        },
        "day6": {
            ...
            "insights": {
                "closure": {
                    "title": "💡 商業大師洞察",
                    "text": "利用機場貴賓室與商務艙的專屬隱私空間，完成這趟考察的最後收斂，將『所見』具體化為下一季的行動策略。"
                }
            },
            "timeline": [
                { 
                    ...
                    "extraInfo": [{ "type": "recommend", "text": "🔥 必吃理由：日本吉野家的『特選黑毛和牛壽喜燒定食』或『烤鮭魚朝食』品質極高，是最具代表性的平民朝食體驗。" }],
                    "cost": "¥600", "stay": "45m" 
                },
                { 
                    ...
                    "description": "專車接送。", 
                    "extraInfo": [
                        { "type": "strategy", "text": "🎯 私房景點大師：若報到後時間充裕，成田周邊的 成田山新勝寺 是名震關東的千年古剎名勝。" }, 
                        { "type": "recommend", "text": "🏪 機場採購：出境前的免稅店 FaSoLa TAX FREE 成田空港 是消耗剩餘日圓現金的最佳戰場。" }
                    ], 
                    "cost": "已含", "stay": "2h" 
                },
            ...
            "intel": { 
                "supply": { 
                    "title": "✈️ 機場免稅最後防線", 
                    "placeKey": "FaSoLa TAX FREE 成田空港",
                    "text": "FaSoLa TAX FREE 成田空港 是伴手禮與精品最後掃貨的絕對主力區。" 
                }
            }
        }
    },
    ...
    "themedGuidesData": {
        "amulets": { 
            ...
            "items": [
                ...
                { "name": "品川神社", "placeKey": "品川神社", "prefecture": "東京都", "popular": "金運御守與洗錢體驗", "special": "境內阿那稻荷神社的一粒萬倍神水加持" }
            ] 
        },
        "souvenirs": { 
            "title": "🛍️ 伴手禮情報", 
            ...
            "items": [
                ...
                { "name": "atré 品川", "placeKey": "atré 品川", "items": ["Blue Bottle 品川店 專屬烘焙咖啡豆"] }
            ] 
        },
        "animePilgrimage": { 
            "title": "🎥 聖地巡禮", 
    ...
    "awardsData": {
        ...
        "greatThree": [
            { 
                ...
                "others": "芝大神宮、神田明神 等其餘九社", "alternative_title": "境內特殊亮點", "alternatives": ["品川神社富士塚"] 
            },
            { 
                "title": "📸 攝影大師絕景推薦", "theme": "border-pink-400", "status": "達人強推", 
                "description": "連在地人都未必知道的都市隱藏版絕景，能同時將東京鐵塔與現代建築收入鏡頭。", 
                "location": { "name": "SHIBUYA SKY", "placeKey": "SHIBUYA SKY", "prefecture": "東京都" }, 
                "others": "六本木之丘展望台", "alternative_title": "大師備案", "alternatives": ["Shibuya Sky 酒吧"] 
            }
        ]
    },
    "seasonalData": {
        "spring": { "title": "春 (3-5月)", "theme_color": "bg-pink-100", "icon": "🌸", "highlights": ["千鳥淵櫻花盛開", "明治神宮 新綠漫步"], "foods": ["時令草莓", "初鰹"] },
        "summer": { "title": "夏 (6-8月)", "theme_color": "bg-blue-100", "icon": "☀️", "highlights": ["東京灣大華火祭", "隅田川屋形船納涼"], "foods": ["國產鰻魚", "山梨水蜜桃"] },
        "autumn": { "title": "秋 (9-11月)", "theme_color": "bg-orange-100", "icon": "🍁", "highlights": ["明治神宮 外苑銀杏大道", "高尾山賞楓"], "foods": ["丹波栗子", "鹽烤秋刀魚"] },
        "winter": { "title": "冬 (12-2月)", "theme_color": "bg-indigo-100", "icon": "❄️", "highlights": ["彩虹大橋 冬季點燈", "新年神社初詣 (參拜)"], "foods": ["松葉蟹", "關東煮與熱清酒"] }
    },
    ...
    "transportTactics": ["<span class='emphasis'>行李無縫轉運：</span>大件行李將由專車底層巴士隨車移動，更換飯店時不需自行提著行李擠電車，達成真正的尊榮商務體驗。", "<span class='emphasis'>市區置物櫃戰術：</span>在澀谷 (Day 5 選項A) 或 秋葉原電器街 (選項B) 進行大量採購時，請尋找 原宿車站 等車站內的投幣式置物櫃（Coin Locker，支援 Suica 付款），解放雙手以利後續觀光。"],
    "prepList": { 
    ...
    "prepMemos": [
        { "title": "⛩️ 特有文化禮節與參拜", "content": "進入神聖的神社領域（如 明治神宮）前，請於手水舍依序洗左手、右手、漱口以淨身；於本殿參拜時，請遵循「二拜、二拍手、一拜」的嚴格規矩。此外，飯店溫泉入浴前必須在淋浴區將身體完全洗淨，且毛巾絕對不可入水池。" },
        { "title": "🍺 飲食習慣與潛規則", "content": "若晚間前往 品川駅 港南口 居酒屋街 聚餐，多數店家會主動送上一小碟名為「お通し (Otooshi)」的付費小菜，這是當地約定俗成的座位費文化，請視為體驗的一部分。此外，正宗的日本拉麵湯頭普遍較為濃郁偏鹹，若需調整，部分店家可接受向店員詢問「味薄め (Aji usume)」。" }
    ],
    "prepExpertTips": [
        { "title": "💳 退稅規範 (Tax-Free) 實戰", "content": "於 ドン・キホーテ 品川港南口店 或藥妝店購物滿 5,000 日圓即可享有免稅。請務必隨身攜帶「實體護照」（不可使用照片影本）。需特別注意：消耗品（如藥妝、食品）退稅後會被封裝在特製免稅袋中，離開日本境內前絕對不可拆封；而一般物品（如電器、衣物）則可直接在日本境內拆開使用。" },
        { "title": "🎫 數位票證極致運用", "content": "Suica 除了搭乘地鐵外，更能廣泛用於車站內的便利商店、飲料自動販賣機、甚至是部分連鎖 松屋 台場店 或 吉野家 品川站前店 的結帳，能大幅減少攜帶零錢硬幣的麻煩，提升行動效率。" }
    ]
};
